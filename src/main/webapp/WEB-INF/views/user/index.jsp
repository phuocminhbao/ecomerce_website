		...
		<div id="sidebar" class="span3">
			<div class="well well-small">
				<ul class="nav nav-list">
					<li><a href="products.html"><span class="icon-chevron-right"></span>Smartphone</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Laptop</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Phone Accessories</a></li>
